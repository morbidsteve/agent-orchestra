...
export const AGENTS: AgentInfo[] = [
  ...
  },
  {
    role: 'frontend-dev',
    name: 'Frontend Dev',
    description: 'Frontend specialist handling React components, styling, UI work, hooks, and pages.',
    status: 'idle',
    capabilities: ['React Components', 'Styling', 'UI/UX', 'Hooks'],
    tools: ['Read', 'Write', 'Edit', 'Bash', 'Grep', 'Glob'],
    color: '#ec4899',
    icon: 'Palette',
    currentExecution: null,
  ...
  },
  {
    role: 'backend-dev',
    name: 'Backend Dev',
    description: 'Backend specialist handling API endpoints, services, data models, and Python logic.',
    status: 'idle',
    capabilities: ['API Endpoints', 'Services', 'Data Models', 'Python'],
    tools: ['Read', 'Write', 'Edit', 'Bash', 'Grep', 'Glob'],
    color: '#8b5cf6',
    icon: 'Server',
    currentExecution: null,
  ...
  },
  {
    role: 'devops',
    name: 'DevOps',
    description: 'DevOps engineer handling Dockerfile changes, CI/CD, deployment config, and infrastructure.',
    status: 'idle',
    capabilities: ['Docker', 'CI/CD', 'Deployment', 'Infrastructure'],
    tools: ['Read', 'Write', 'Edit', 'Bash', 'Grep', 'Glob'],
    color: '#eab308',
    icon: 'Container',
    currentExecution: null,
